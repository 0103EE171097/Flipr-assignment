...
function MainScreen(props) {
  ...
  const email = "0103ee171097@gmail.com";
  const config = {
      ...
      <div className="cart-set">
        <div className="btn-group" role="group" aria-label="Basic example">
          <button
            ...
            onClick={DELHandler}
            className={
              filter === "DEL" ? "cart-buttom-zero" : "cart-buttom-one"
            }
          >
          ...
          <button
            ...
            onClick={INTHandler}
            className={
              filter === "INT" ? "cart-buttom-zero" : "cart-buttom-one"
            }
          >
          ...
          <button
            ...
            onClick={OODHandler}
            className={
              filter === "OOD" ? "cart-buttom-zero" : "cart-buttom-one"
            }
          >
          ...
          <button
            ...
            onClick={DEXHandler}
            className={
              filter === "DEX" ? "cart-buttom-zero" : "cart-buttom-one"
            }
          >
          ...
          <button
            ...
            onClick={NFIHandler}
            className={
              filter === "NFI" ? "cart-buttom-zero" : "cart-buttom-one"
            }
          >
